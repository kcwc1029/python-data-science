# -*- coding: utf-8 -*-
"""範例 15：排隊人數與階梯圖。詳解請搭配折線圖 Notebook。"""
...
axes[0].plot(minutes, people, marker="o")
axes[0].set_title("普通連線：容易以為人數逐漸增加")
axes[1].step(minutes, people, where="post", marker="o")
axes[1].set_title("階梯圖：事件後保持當下人數")
for ax in axes:
    ax.set(xlabel="開始記錄後經過幾分鐘", ylabel="排隊人數（人）", ylim=(0, 7))
plt.show()
