# -*- coding: utf-8 -*-
"""範例 26：每位同學各畫一條線。詳解請搭配折線圖 Notebook。"""
...
df = read_data("09_散步打卡.csv")
print(df.head())
fig, ax = plt.subplots()
sns.lineplot(data=df, x="週次", y="散步天數", hue="同學", style="同學",
             units="同學", estimator=None, errorbar=None, markers=True, ax=ax)
